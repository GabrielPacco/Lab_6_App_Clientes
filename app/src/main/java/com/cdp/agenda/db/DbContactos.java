...
public class DbContactos extends DbHelper {
    ...
    public long insertarContacto(String nombre, String direccion,String telefono, String correo_electronico) {
    ...
    public boolean editarContacto(int id, String nombre, String direccion, String telefono, String correo_electronico) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', direccion = '" + direccion + "', telefono = '" + telefono + "', correo_electronico = '" + correo_electronico + "' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
